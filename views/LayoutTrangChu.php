          ...
          <div class="item" > 
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel"> 
              ...
              <div class="carousel-inner">
                <div class="item active"> <img src="assets/frontend/100/047/633/themes/517833/assets/banner_home_1.jpg" alt="Los Angeles"> </div>
                <div class="item"> <img src="assets/frontend/100/047/633/themes/517833/assets/sony-banner.jpg" alt="Los Angeles"> </div>
                <div class="item"> <img src="assets/frontend/100/047/633/themes/517833/assets/photo-3-1639119465917474835762-1639124776358-16391247764981299659325.jpg" alt="Chicago"> </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-3">
          <h3>THÔNG TIN SONY</h3>
          <ul class="list-unstyled">
            <li><a href="https://SONY.vn/he-thong-sieu-thi">Hệ thống 360 (8:00-21:30)</a></li>
            <li><a href="https://SONY.vn/thong-tin-chung/gioi-thieu-cong-ty">Giới thiệu công ty</a></li>
            <li><a href="https://SONY.vn/tuyen-dung">Tuyển dụng</a></li>
            <li><a href="https://SONY.vn/chinh-sach-chung/quy-dinh-thanh-toan">Phương thức thanh toán</a></li>
          </ul>
        </div>
        <div class="col-xs-12 col-sm-3">
          <h3>Hỗ trợ khách hàng</h3>
          <ul class="list-unstyled">
            <li><a href="https://SONY.vn/ho-tro-mua-hang/huong-dan-mua-hang-online">Hướng dẫn mua hàng Online</a></li>
            <li><a href="https://SONY.vn/uu-dai-tra-gop">Mua hàng trả góp</a></li>
            <li><a href="https://SONY.vn/chinh-sach-chung/chinh-sach-doi-tra-hang">Chính sách bảo hành, đổi trả</a></li>
            <li><a href="https://SONY.vn/chinh-sach-chung/chinh-sach-giao-nhan">Giao hàng và lắp đặt</a></li>
            <li><a href="https://SONY.vn/chinh-sach-chung/quy-dinh-bao-mat">Chính sách bảo mật TT cá nhân</a></li>
            <li><a href="https://tracuuhoadon.SONY.com.vn/">In hóa đơn điện tử</a></li>
          </ul>
        </div>
        <div class="col-xs-12 col-sm-3">
        ...
        <div class="col-xs-12 col-sm-3">
        <img src="assets\upload\products\Sony-logo.png" alt="" width="80%">
        </div>
      </div>
