<header id="header">
  ...
  <div class="mid-header">
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 logo "> <a href="index.php"> <img src="assets\upload\products\Sony-logo.png" alt="User" title="User" class="img-responsive" style="height: 60px;width: 200px;object-fit: cover;"> </a> </div>
        <div class="col-xs-12 col-sm-12 col-md-5 header-search">
        ...
        ?>
        <!-- <div class="col-xs-12 col-sm-12 col-md-2 mini-cart">
        </div> -->
        <div class="col-xs-12 col-sm-12 col-md-2 mini-cart">
        ...
        <div class="col-xs-12 col-sm-12 col-md-2 mini-cart">
          <?php if (isset($_SESSION["customer_email"]) == false) : ?>
            <span style="line-height: 40px;"><i class="fa fa-user">&nbsp;</i><a href="index.php?controller=account&action=login">Đăng nhập</a></span>&nbsp; &nbsp;<span><i class="fa fa-user-plus"></i>&nbsp;<a href="index.php?controller=account&action=register">Đăng ký</a></span>
          <?php else : ?>
            <a style="line-height: 40px;" href="#"><img src="https://cdn-icons-png.flaticon.com/512/149/149071.png" alt="" width="40px" ></a>&nbsp; &nbsp;<a href="index.php?controller=account&action=logout">Đăng xuất</a>
          <?php endif; ?>
        </div>
      </div>
    </div>
