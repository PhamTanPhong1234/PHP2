<?php 
	...
	class ProductsController extends Controller{
		...
		public function index(){
			$recordPerPage = 20;
			//tinh so trang
			//ham ceil la ham lay trang va lam tròn số. VD: ceil(2.1) = 3
			$numPage = ceil($this->modelAllTotal()/$recordPerPage);
			//lay danh sach cac ban ghi co phan trang
			$data = $this->modelAllRead($recordPerPage);
			// echo $this->modelAllTotal();
			;
